...
(function () {
  function openProjectModal(projectId) {
    ...
    modalBody.innerHTML = `
      ${project.image ? `<div style="border-radius: var(--radius-md); overflow: hidden; margin-bottom: 16px; border: 1px solid var(--border-color); background: #080c14; padding: 6px; box-shadow: var(--shadow-md);"><img src="${project.image}" alt="${project.title}" style="width: 100%; height: auto; max-height: 340px; object-fit: contain; display: block; margin: 0 auto; border-radius: 6px;"></div>` : ''}
